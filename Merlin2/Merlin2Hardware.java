...
public class Merlin2Hardware
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        LeftRange = hwMap.get(ModernRoboticsI2cRangeSensor.class, "RightRange");//Finds the range sensor in the hardware map
        RightRange = hwMap.get(ModernRoboticsI2cRangeSensor.class, "LeftRange");
        ...
        LiftCollector = hwMap.dcMotor.get("Lift");//Finds the sweeper in the hardware map
