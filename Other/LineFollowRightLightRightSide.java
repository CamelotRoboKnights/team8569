...
public class LineFollowRightLightRightSide extends LinearOpMode { //The name after public class needs to be the same as the file name
    ...
    public void runOpMode() {
        ...
        double TargetLightValue = 0.02833764;//The left is 0.0771358 and the right is .02833764
        ...
        while (opModeIsActive()) {
            CurrentLightValue = robot.RightLight.getLightDetected();
