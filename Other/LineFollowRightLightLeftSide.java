...
//This code follows the line on the right side with the Left sensor
...
public class LineFollowRightLightLeftSide extends LinearOpMode { //The name after public class needs to be the same as the file name
