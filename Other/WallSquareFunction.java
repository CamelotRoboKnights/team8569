    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            RightRange = robot.rangeSensor.getDistance();
            LeftRange = robot.rangeSensor2.getDistance();
            RangeDifference = RightRange - LeftRange;
            RangeScaled = RangeDifference*.05;

            Motor1WallSquarePower = 0.2 + RangeScaled;
            Motor2WallSquarePower = 0.2 - RangeScaled;
            Motor3WallSquarePower = 0.2 + RangeScaled;
            Motor4WallSquarePower = 0.2 - RangeScaled;
