    ...
    public void loop(){//This runs while opmode is active
        ...
        switch (currentCase){
            ...
            case "RaiseGlyphCollectorAndOtherCases":
                ...
                boolean doneRaising = robot.glyphCollector.raiseToValue(0);
            ...
            case "Deliver":
                ...
                doneRaising = robot.glyphCollector.raiseToValue(robot.glyphCollector.maximumHeight/2);
                telemetry.addData("CurrentLowerCase", lowerCase);
                telemetry.addData("Height", robot.glyphCollector.getCurrentMotorPosition());
                switch (lowerCase) {
                    ...
                    case "DriveIntoCryptoBox":
                        thisLowerCaseDone = robot.westCoast.driveBasedOnEncodersAndGyro(30, 1, true, 90, currentAngle);
                        if(thisLowerCaseDone){
                            lowerCase = "ReleaseGripper";
                        }
                        break;
                    case "ReleaseGripper": //release glyph
                        robot.glyphCollector.topGrasper.open();
                    ...
                    case "DriveBack2":
                        ...
                        break;
                    case "DriveBack3":
                        thisLowerCaseDone = robot.westCoast.driveBasedOnEncoders(2, -1, true);
                        if(thisLowerCaseDone){
                            lowerCase = "End";
                        }
                        break;
