...
public class WestCoastRedC extends OpMode {
    ...
    private double driveDistanceToRightColumn = 22;//
    private double driveDistanceToCenterColumn = 30;//
    private double driveDistanceToLeftColumn = 37;//38
    ...
    public void loop(){//This runs while opmode is active
        ...
        switch (currentCase){
            ...
            case "DriveBack":
                ...
                break;
            case "DriveForward2":
                doneYet = robot.westCoast.driveBasedOnEncodersAndGyro(driveAwayFromCryptobox+1, 1, true, 90, currentAngle) || time();
                if(doneYet){
